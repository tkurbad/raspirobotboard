...
class Adafruit_I2C :
    ...
    def __init__(self, address, busnum = None, debug = False):
        ...
        # By default, the correct I2C bus is auto-detected using
        # /proc/cpuinfo.
        # Alternatively, you can provide the bus number in the parameter
        # busnum:
    ...
    def write16(self, reg, value):
        """ Writes a 16-bit value to the specified register/address
            pair.
        """
        try:
